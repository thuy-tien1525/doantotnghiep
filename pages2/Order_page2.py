...
class OrderPage:
    def __init__(self, driver):
        self.driver = driver
        self.btn_add = (By.CSS_SELECTOR, "button[class='btn btn_add_cart btn-cart add_to_cart is-full']")
        self.cart_icon = (By.XPATH, "//div[@class='header-wrap container']//a[@title='Giỏ hàng']//*[name()='svg']")
        self.btn_checkout = (By.XPATH, "//button[@title='Tiến hành thanh toán']")
